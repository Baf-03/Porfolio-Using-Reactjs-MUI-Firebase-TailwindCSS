...
function Home() {
  ...
  return (
    <>
    {allProducts.length>0?( <div className="xl:w-[80%] h-[100vh] mx-auto mt-[8%]">
      ...
      </div>):(<div className='w-[100%] flex justify-center items-center h-[80vh] text-[3rem] font-bold'>Loading  <div className='w-[5vw] '><Spinner className=" w-[100%] h-[5rem]" color="pink" /></div></div>)}
